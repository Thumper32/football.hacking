...
def plot_venue_performances(df: pd.DataFrame, home_team: str, away_team: str) -> None:
    ...
    sns.barplot(data=df_home, x='home', y='weighted_performance_home', ax=ax, color='#11163D')
    sns.barplot(data=df_away, x='away', y='weighted_performance_away', ax=ax, color='#3D2211')
    sns.despine()
